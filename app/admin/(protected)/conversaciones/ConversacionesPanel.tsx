...
/**
 * El cuerpo de la pantalla de conversaciones de WhatsApp, aparte de la
 * página en sí (app/admin/(protected)/conversaciones/page.tsx) para
 * poder reutilizarlo también dentro de la burbuja flotante del panel
 * (ver WhatsAppFlotante.tsx) — mismo componente, dos sitios donde verlo:
 * a pantalla completa o en un popup.
 */
    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
      <div className="divide-y divide-stone-200 rounded-lg border border-stone-200 bg-white md:col-span-1">
        {conversaciones.map((c) => (
          ...
          >
            <div className="font-medium text-stone-900">{c.cliente?.nombre ?? c.telefono ?? "Cliente sin identificar"}</div>
          ...
          <div className="flex h-[28rem] flex-col">
            ...
            <div className="mt-3 flex gap-2">
              ...
              <button
                ...
                className="rounded-lg bg-brand-yellow px-4 py-2 text-sm font-medium text-brand-yellow-ink disabled:opacity-50"
              >
                Enviar
              </button>
            </div>
